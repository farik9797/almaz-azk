    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 pb-10 border-b border-slate-800">
      ...
      <div class="lg:col-span-4 space-y-3">
        ...
        <div class="space-y-2 text-xs">
          <div><span class="text-slate-400 block text-[11px]">Оптовые поставки:</span><a href="tel:<?php echo esc_attr(azk_tel($phone_wholesale)); ?>" class="font-bold text-white hover:text-accent"><?php echo esc_html($phone_wholesale); ?></a></div>
          <div><span class="text-slate-400 block text-[11px]">Сеть АЗС и карты:</span><a href="tel:<?php echo esc_attr(azk_tel($phone_retail)); ?>" class="font-bold text-white hover:text-accent"><?php echo esc_html($phone_retail); ?></a></div>
          <div><span class="text-slate-400 block text-[11px]">Приёмная и общие вопросы:</span><a href="tel:<?php echo esc_attr(azk_tel($phone_general)); ?>" class="font-bold text-white hover:text-accent"><?php echo esc_html($phone_general); ?></a></div>
        </div>
      </div>
    </div>
